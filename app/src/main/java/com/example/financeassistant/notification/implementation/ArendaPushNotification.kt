...
class ArendaPushNotification(private val context: Context, private val notificationData: Map<String, Any>?) : DefaultPushNotification(context, notificationData) {

    override fun notificationIdGroupName(): String {
        return TaskType.Arenda.name
    }

    override fun notificationIdGroupKey(): String {
        return context.getString(R.string.notification_group_key_arenda)
    }

    override fun notificationChannelId(): String {
        return context.getString(R.string.notification_channel_id_arenda)
    }
    ...
    override fun notificationTitle(): String {
        return context.getString(R.string.notification_title_arenda)
    }
