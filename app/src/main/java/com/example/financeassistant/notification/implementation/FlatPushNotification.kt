...
class FlatPushNotification(private val context: Context, private val notificationData: Map<String, Any>?) : DefaultPushNotification(context, notificationData) {

    override fun notificationIdGroupName(): String {
        return TaskType.Flat.name
    }

    override fun notificationIdGroupKey(): String {
        return context.getString(R.string.notification_group_key_flat)
    }
    ...
    override fun notificationTitle(): String {
        return context.getString(R.string.notification_title_flat)
    }
}
